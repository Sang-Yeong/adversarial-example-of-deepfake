...
def get_transforms(image_size):
    ...
    transforms_train = albumentations.Compose([
        ...
        # albumentations.MedianBlur(blur_limit=25,always_apply=True),
        #    albumentations.ToGray(always_apply=True),
            albumentations.MotionBlur(blur_limit=3,always_apply=True),
            albumentations.GaussianBlur(blur_limit= 3,always_apply=True),
            albumentations.GaussNoise(var_limit= 10.0,always_apply=True),
